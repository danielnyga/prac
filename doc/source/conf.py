...
project = 'PRAC'
copyright = u'%s, Daniel Nyga, Mareike Picklum' % datetime.datetime.now().year
...
html_context = {
    'teaser_text' : "We are happy to announce Version {} of PRAC!".format(version)
}
...
# of the sidebar.
html_logo = os.path.join('_static', 'img', 'prac-brightondark-transp.png')
...
latex_documents = [
  ('index', 'PRAC.tex', 'PRAC Documentation',
   'Daniel Nyga, Mareike Picklum', 'manual'),
]
...
man_pages = [
    ('index', 'prac', 'PRAC Documentation',
     ['Daniel Nyga, Mareike Picklum'], 1)
]
...
texinfo_documents = [
  ('index', 'PRAC', 'PRAC Documentation',
   'Daniel Nyga, Mareike Picklum', 'PRAC', 'One line description of project.',
   'Miscellaneous'),
]
